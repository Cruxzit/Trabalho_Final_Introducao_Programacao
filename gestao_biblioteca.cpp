...
// Estrutura de dados para armazenar informações do livro
struct Livro {
...
// Estrutura de dados para armazenar informações do utilizador
struct Utilizador {
    string nome, id;
...
// Pesquisar livro por título, autor ou gênero
void pesquisarLivro() {
    string termo;
    int criterio;
